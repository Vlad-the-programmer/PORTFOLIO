...
class DistInfoDistribution(Distribution):
    ...
    @property
    def _parsedpk_g_info(self):
        """Parse and cache metadata"""
        try:
            return self.pk_g_info
        except AttributeError:
            metadata = self.get_metadata(self.PKG_INFO)
            self.pk_g_info = email.parser.Parser().parsestr(metadata)
            return self.pk_g_info
    ...
    def _compute_dependencies(self):
        ...
        for req in self._parsedpk_g_info.get_all('Requires-Dist') or []:
        ...
        for extra in self._parsedpk_g_info.get_all('Provides-Extra') or []:
