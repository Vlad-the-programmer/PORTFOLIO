...
def writepk_g_info(cmd, basename, filename):
    ...
    if not cmd.dry_run:
        ...
        try:
            ...
            # can still parse it
            metadata.writepk_g_info(cmd.egg_info)
        finally:
...
def getpk_g_info_revision():
    """
    Get a -r### off of PKG-INFO Version in case this is an sdist of
    a subversion revision.
    """
    warnings.warn(
        "getpk_g_info_revision is deprecated.", EggInfoDeprecationWarning)
