...
def writepk_g_file(self, file):  # noqa: C901  # is too complex (14)  # FIXME
...
class Distribution(_Distribution):
    ...
    def patch_missingpk_g_info(self, attrs):
    ...
    def __init__(self, attrs=None):
        ...
        self.patch_missingpk_g_info(attrs)
